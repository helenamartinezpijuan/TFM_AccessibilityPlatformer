...
[System.Serializable]
public class BeamConnectionVideo
{
...
public class BeamEffectControllerVideo : MonoBehaviour
{
    [Header("Beam Connections")]
    public BeamConnectionVideo beamConnection;
    ...
    private void InitializeBeam(BeamConnectionVideo connection)
    {
        // Create GameObject for this beam
        GameObject beamObject = new GameObject($"Beam_Test");
    ...
    private void InstantiateParticleSystems(BeamConnectionVideo connection, GameObject parentObject)
    {
        // Start particles
    ...
    {
                UpdateBeamPath(beamConnection);
    }
    
    private void UpdateBeamPath(BeamConnectionVideo connection)
    {
    ...
    private List<Vector2> GetBeamPath(BeamConnectionVideo connection, Vector2 start, Vector2 end)
    {
    ...
    private void UpdateParticleSystems(BeamConnectionVideo connection, List<Vector2> path)
    {
    ...
    private void EmitBeamParticles(BeamConnectionVideo connection, List<Vector2> path)
    {
    ...
    private void ApplyPulsingEffect(BeamConnectionVideo connection)
    {
